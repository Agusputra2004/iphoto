        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="<?php echo site_url('pages/contact'); ?>" class="py-2 d-block">Contact Us</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
           <div class="ftco-footer-widget mb-4">
            ...
            <div class="d-flex">
                <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                  <li><a href="<?php echo site_url('shop/cart'); ?>" class="py-2 d-block">Cart</a></li>
                  <li><a href="<?php echo site_url('customer/payments/confirm'); ?>" class="py-2 d-block">Payment Confirmation</a></li>
                  <li><a href="<?php echo site_url('shop/testimonial'); ?>" class="py-2 d-block">Customer Testimonials</a></li>
                </ul>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with</i> Axs.
