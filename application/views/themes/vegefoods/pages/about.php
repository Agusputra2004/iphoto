...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg2.jfif'); ?>');">
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><?php echo anchor(base_url(), 'Home'); ?></span> <span>About Us</span></p>
  ...
  <!-- <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 heading-section ftco-animate text-center">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. At eveniet vitae eius aspernatur quidem numquam ex non. Ipsam repellat adipisci, eum nisi accusantium eius, impedit placeat animi nesciunt esse veritatis.</p>
        </div>
      </div>
