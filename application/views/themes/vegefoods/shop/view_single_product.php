      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <div class="w-100"></div>
                <div class="col-md-12">
                    <p style="color: #000;">Available <?php echo $product->stock; ?> <?php echo $product->product_unit; ?></p>
                </div>
            </div>
  ...
  <section class="ftco-section">
      <div class="container">
        ...
        <div class="col-md-12 heading-section text-center ftco-animate">
            <span class="subheading">Other Products</span>
          <h2 class="mb-4">Other Related Products</h2>
        </div>
      </div>   		
      </div>
      <div class="container">
