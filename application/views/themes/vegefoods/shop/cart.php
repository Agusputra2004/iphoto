...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg2.jfif'); ?>');">
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          ...
          <h1 class="mb-0 bread">My Shopping Cart</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <div class="row justify-content-end">
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  <div class="cart-total mb-3">
                      <h3>Coupon Code</h3>
                      <p>Have a Coupon Code?, Use your coupon to get attractive discounts</p>
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  <div class="cart-total mb-3">
                      ...
                      <p class="d-flex">
                          ...
                          <span class="n-ongkir font-weight-bold">Free</span>
                          <?php else : ?>
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">No items in cart.<br><?php echo anchor('browse', 'Explore Our Product'); ?> And start buy a product!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
